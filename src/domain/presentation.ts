...
export const steps: PresentationStep[] = [
    ...
    content: {
      metrics: [
        { value: 14.6, decimals: 1, suffix: " de glosa" },
        {
          value: 50,
          decimals: 0,
          suffix: " do tempo consumido por tarefas administrativas",
        },
      ],
      bullets: [
  ...
  },
  {
    ...
    content: {
      ...
      body: "Adapters tipados, FHIR/HL7 e barramentos de eventos transformam sistemas existentes em ferramentas que o agente sabe operar.",
      bullets: [
  ...
  },
  {
    ...
    content: {
      ...
      body: "Cada decisão do agente deixa rastro auditável: qual modelo, com quais dados, sob qual política, com qual alçada. Compliance não é módulo — é fundação.",
      bullets: [
  ...
  },
  {
    ...
    content: {
      ...
      body: "O caminho começa com casos de uso de baixo risco e alta alavancagem, expandindo escopo e autonomia conforme a confiança operacional cresce.",
      bullets: [
  ...
  },
  {
    ...
    content: {
      ...
      body: 'A era agêntica devolve tempo às equipes clínicas, atenção aos pacientes e previsibilidade às operações. A pergunta deixou de ser "se" — passou a ser "com quem".',
      meta: {
