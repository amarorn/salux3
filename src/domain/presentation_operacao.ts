  ...
  .map((s) => {
      ...
      return {
        ...
        content: {
          ...
          valueStages: [
            ...
            {
              number: "+",
              label: "Mais estrutura física para cada nova frente",
            },
            {
              number: "+",
              label: "Mais pressão sobre equipes e áreas críticas",
            },
          ],
          body: "Isso não é um desvio pontual. É um padrão.\nA instituição amplia capacidade — mas também amplia complexidade.",
          attentionPhrase:
    ...
    if (s.id === "architecture") {
      return {
        ...
        content: {
          ...
          cardVisual: "gear",
          lead: "A maioria das instituições já tem sistemas, módulos, BI, prontuário, integrações e controles.",
          closingHighlight:
            "Um conjunto de sistemas não forma, necessariamente, uma arquitetura.",
          body: "Durante anos, a saúde avançou informatizando partes da operação. Isso foi necessário.\nMas informatizar partes não significa coordenar o todo.",
          evidenceMetrics: [
            {
              style: "gauge",
    ...
    if (s.id === "journey") {
      return {
        ...
        subtitle:
          "Do sistema-a-adicionar para a base que permite crescer sem multiplicar complexidade",
        content: {
          ...
          closingHighlight:
            "Crescer por arquitetura é diferente de crescer por acúmulo.",
          bullets: [],
          highlightPhrases: [],
          painPointsLayout: false,
    ...
    if (s.id === "governance") {
      return {
        ...
        content: {
          ...
          cardVisual: "modular",
          body: "O Ecossistema Salux organiza capacidades para cada ponto da operação — de forma integrada, não como produtos isolados.",
          capacityGroups: [
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  productImage: "/operacao_4/Diagnostico_Integrado.MOV",
                },
                {
              ...
              items: [
                {
                  ...
                  description: "Rastreabilidade, conformidade e continuidade.",
                  tagline: "Crescer sem fragilidade documental.",
                  productImage: "/operacao_4/governanca_documental.mkv",
                },
                {
                ...
                },
                {
                  ...
                  productImage: "/operacao_4/areas_críticas.mp4",
                },
              ],
            },
          ],
    ...
    if (s.id === "closing") {
      return {
        ...
        content: {
          ...
          closingQuestion:
            "Se a sua próxima expansão começasse amanhã, o que travaria primeiro?",
          highlightPhrases: [],
        },
      };
    }
...
const extraOperacao: PresentationStep[] = [
  ...
  },
  {
    ...
    content: {
      ...
      valueStages: [
        {
          number: "🔧",
          label: "Legado / Integração",
          description: "→ Plataforma Salux + INITIA",
        },
        { number: "📡", label: "Capilaridade", description: "→ CloudHealth" },
        {
          number: "🔬",
          label: "Imagem / Diagnóstico",
          description: "→ Med.Place",
        },
        {
          number: "👥",
          label: "Equipe / Custo operacional",
          description: "→ StarGrid",
        },
        { number: "📄", label: "Documentação", description: "→ ZeroDox" },
        {
          number: "💰",
          label: "Faturamento / Glosas",
          description: "→ TI Hospitalar",
        },
        {
          number: "🏥",
          label: "Centro cirúrgico / Áreas críticas",
          description: "→ SkyMed + VisionPilot / AGCOM",
        },
      ],
  ...
  },
  {
    ...
    index: 0,
    title:
      "O valor não está em crescer mais. Está em reduzir o custo estrutural de crescer.",
    subtitle:
      "Resultado: base coordenada, expansão sem multiplicar complexidade",
    position: { x: 1320, y: 3320 },
    scale: 1.2,
    kind: "narrative",
    accent: "emerald",
    content: {
      ...
      valueStages: [
        ...
        {
          number: "✓",
          label: "Mais previsibilidade sobre demanda e capacidade",
        },
        { number: "✓", label: "Mais consistência entre unidades e serviços" },
        {
          number: "✓",
          label: "Menos retrabalho e costura manual a cada expansão",
        },
        {
          number: "✓",
          label: "Menos fricção estrutural e dependências de legado",
        },
        {
          number: "✓",
          label: "Mais controle sobre a escala sem ampliar complexidade",
        },
      ],
      productExamples: [
        {
          caption: "Base coordenada em operação",
          imageSrc: "/trilha3_slide9.png",
          alt: "Resultado da operação coordenada",
        },
      ],
      closingHighlight:
